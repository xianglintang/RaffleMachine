...
public class CreateNotEliminateItem:MonoBehaviour
{
    ...
    void OnEnable()
    {
        gameObjects = NotEliminatePanel.GetComponent<NotEliminateManagement>().gameObjects;
    ...
    public void CreateNewItem()
    {
        ...
        Item.itemData = new NotEliminateItemData();
        Item.itemData.SetNotEliminateItemData(Item);
        //可序列化类完成赋值再交付给数据管理中心
        transferStation.ListNotEliminateItemData.Add(Item.itemData);
